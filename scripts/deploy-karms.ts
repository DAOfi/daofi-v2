...
async function main() {
  ...
  const proxy = process.env.PROXY || '0xf57b2c51ded3a29e6891aba85459d600256cf317' // Default Rinkeby // Mainnet 0xa5409ec958c83c3f309868babaca7c86dcb077c1
  ...
  const pair = new Contract('0x32093ef03141eac8bfad7119fc37ad9985efe763', DAOfiV2Pair.abi, wallet) // Mainnet
